...
LRESULT CALLBACK LLKeyboardProc(int nCode, WPARAM wp, LPARAM lp)
{
	...
	// 로깅용 //jjsgsggsffgg780buhii0123456789/*-+11
	WCHAR bf[1024] = L"\0";
	swprintf(bf, L"nCode:%d\n", k.vkCode);
    ...
    if(isDeadKey) {
        ...
        // }
        // deadKeyPressed = TRUE;
		OutputDebugStringW(L"isDeadKey\n");
    } else if(wp == WM_KEYUP || wp == WM_SYSKEYUP) {

		OutputDebugStringW(L"isDeadKey1\n");//111
		...
		OutputDebugStringW(L"isDeadKey2\n");
